...
console.log('The author of bookshelf[1] is:', bookshelf[1].author);
console.log('The ISBN of bookshelf[0] is:', bookshelf[0].isbn);
console.log('The title of bookshelf[2] is:', bookshelf[2].title);
